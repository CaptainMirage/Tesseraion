...
export default class TesseraionWallpaperExtension extends Extension {
    enable() {
        ...
        // Pause the clones (and so idle the host) when locked or fullscreen-covered.
        this._lifecycle = new Lifecycle(this._background);
    ...
    disable() {
        // Tear down in reverse: stop the pause watcher, stop painting clones, restore
        // the shell methods, then kill the host. Each guard tolerates a partial enable().
